...
public class RobotsActivity extends BaseActivity {
	...
	protected void onCreate(Bundle arg0) {
		super.onCreate(arg0);
		setContentView(com.tg.tgt.R.layout.em_fragment_robots);
		inputMethodManager = (InputMethodManager) getSystemService(INPUT_METHOD_SERVICE);
		ListView mListView = (ListView) findViewById(com.tg.tgt.R.id.list);
		swipeRefreshLayout = (SwipeRefreshLayout) findViewById(com.tg.tgt.R.id.swipe_layout);
		if (android.os.Build.VERSION.SDK_INT >= 14) {
			swipeRefreshLayout.setColorSchemeResources(android.R.color.holo_blue_bright, android.R.color.holo_green_light,
					android.R.color.holo_orange_light, android.R.color.holo_red_light);
		}
		progressBar = findViewById(com.tg.tgt.R.id.progress_bar);
	...
	class RobotAdapter extends ArrayAdapter<RobotUser> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			if (convertView == null) {
				convertView = inflater.inflate(com.tg.tgt.R.layout.em_row_robots, parent, false);
			}
			((TextView) convertView.findViewById(com.tg.tgt.R.id.name)).setText(getItem(position).getNick());
			return convertView;
		}
