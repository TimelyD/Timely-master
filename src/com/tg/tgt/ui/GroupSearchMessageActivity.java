...
public class GroupSearchMessageActivity extends BaseActivity implements OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.tg.tgt.R.layout.em_activity_group_search_message);
        
        query = (EditText) findViewById(com.tg.tgt.R.id.query);
        // clear button
        clearSearch = (ImageButton) findViewById(com.tg.tgt.R.id.search_clear);
        listView = (ListView) findViewById(com.tg.tgt.R.id.listview);
        TextView emptyView = (TextView) findViewById(com.tg.tgt.R.id.tv_no_result);
        listView.setEmptyView(emptyView);
        emptyView.setVisibility(View.INVISIBLE);
        TextView cancleView = (TextView) findViewById(com.tg.tgt.R.id.tv_cancel);
        searchView = (TextView) findViewById(com.tg.tgt.R.id.tv_search);
        ...
        query.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                searchView.setText(String.format(getString(com.tg.tgt.R.string.search_contanier), s));
            }
        });
    ...
    private void searchMessages(){
        ...
        pd.setMessage(getString(com.tg.tgt.R.string.searching));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
        case com.tg.tgt.R.id.tv_cancel:
            finish();
            break;
        case com.tg.tgt.R.id.tv_search:
            hideSoftKeyboard();
            searchMessages();
            break;
        default:
    ...
    private class SearchedMessageAdapter extends ArrayAdapter<EMMessage> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                convertView = LayoutInflater.from(getContext()).inflate(com.tg.tgt.R.layout.em_row_search_message, parent, false);
            }
            ViewHolder holder = (ViewHolder) convertView.getTag();
            if (holder == null) {
                holder = new ViewHolder();
                holder.name = (TextView) convertView.findViewById(com.tg.tgt.R.id.name);
                holder.message = (TextView) convertView.findViewById(com.tg.tgt.R.id.message);
                holder.time = (TextView) convertView.findViewById(com.tg.tgt.R.id.time);
                holder.avatar = (ImageView) convertView.findViewById(com.tg.tgt.R.id.avatar);
