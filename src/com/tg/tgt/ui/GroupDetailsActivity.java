...
//        }
//
//		setContentView(com.tg.tgt.R.layout.em_activity_group_details);
//
//		instance = this;
//		st = /*getResources().getString(com.tg.tgt.R.string.people)*/")";
//
//		mTvMemberCount = (TextView) findViewById(R.id.tv_group_member_count);
//		mTvMemberCount.setText(String.format(getString(R.string.number_of_group_member), this.group.getMemberCount()));
//
//		RelativeLayout clearAllHistory = (RelativeLayout) findViewById(com.tg.tgt.R.id.clear_all_history);
//		loadingPB = (ProgressBar) findViewById(com.tg.tgt.R.id.progressBar);
//		exitBtn = (Button) findViewById(com.tg.tgt.R.id.btn_exit_grp);
//		deleteBtn = (Button) findViewById(com.tg.tgt.R.id.btn_exitdel_grp);
//		RelativeLayout changeGroupNameLayout = (RelativeLayout) findViewById(com.tg.tgt.R.id.rl_change_group_name);
//		RelativeLayout changeGroupDescriptionLayout = (RelativeLayout) findViewById(com.tg.tgt.R.id.rl_change_group_description);
//		RelativeLayout idLayout = (RelativeLayout) findViewById(com.tg.tgt.R.id.rl_group_id);
//		idLayout.setVisibility(View.VISIBLE);
//		TextView idText = (TextView) findViewById(com.tg.tgt.R.id.tv_group_id_value);
//
//		RelativeLayout rl_switch_block_groupmsg = (RelativeLayout) findViewById(com.tg.tgt.R.id.rl_switch_block_groupmsg);
//		switchButton = (EaseSwitchButton) findViewById(com.tg.tgt.R.id.switch_btn);
//		RelativeLayout searchLayout = (RelativeLayout) findViewById(com.tg.tgt.R.id.rl_search);
//
//		RelativeLayout blockOfflineLayout = (RelativeLayout) findViewById(com.tg.tgt.R.id.rl_switch_block_offline_message);
//		offlinePushSwitch = (EaseSwitchButton) findViewById(com.tg.tgt.R.id.switch_block_offline_message);
//
//		idText.setText(groupId);
//		if (this.group.getOwner() == null || "".equals(this.group.getOwner())
//				|| !this.group.getOwner().equals(EMClient.getInstance().getCurrentUser())) {
...
//
//		((TextView) findViewById(com.tg.tgt.R.id.group_name)).setText(this.group.getGroupName() + "(" + this.group
//				.getMemberCount() + st);
//
//		membersAdapter = new GridAdapter(this, com.tg.tgt.R.layout.em_grid_owner, new ArrayList<String>());
//		EaseExpandGridView userGridview = (EaseExpandGridView) findViewById(com.tg.tgt.R.id.gridview);
//		userGridview.setAdapter(membersAdapter);
//
//		ownerAdminAdapter = new OwnerAdminAdapter(this, com.tg.tgt.R.layout.em_grid_owner, new ArrayList<String>());
//		EaseExpandGridView ownerAdminGridview = (EaseExpandGridView) findViewById(com.tg.tgt.R.id.owner_and_administrators_grid_view);
...
//		String st1 = getResources().getString(com.tg.tgt.R.string.being_added);
//		String st2 = getResources().getString(com.tg.tgt.R.string.is_quit_the_group_chat);
//		String st3 = getResources().getString(com.tg.tgt.R.string.chatting_is_dissolution);
//		String st4 = getResources().getString(com.tg.tgt.R.string.are_empty_group_of_news);
//		final String st5 = getResources().getString(com.tg.tgt.R.string.is_modify_the_group_name);
//		final String st6 = getResources().getString(com.tg.tgt.R.string.Modify_the_group_name_successful);
//		final String st7 = getResources().getString(com.tg.tgt.R.string.change_the_group_name_failed_please);
//
//		final String st8 = getResources().getString(com.tg.tgt.R.string.is_modify_the_group_description);
//		final String st9 = getResources().getString(com.tg.tgt.R.string.Modify_the_group_description_successful);
//		final String st10 = getResources().getString(com.tg.tgt.R.string.change_the_group_description_failed_please);
//
...
//									public void run() {
//										((TextView) findViewById(com.tg.tgt.R.id.group_name)).setText(group.getGroupName() + "(" + group.getMemberCount() + ")");
...
//
//				membersAdapter = new GridAdapter(GroupDetailsActivity.this, com.tg.tgt.R.layout.em_grid_owner, new ArrayList<String>());
//
...
//				userGridview.setAdapter(membersAdapter);
//
//				mTvMemberCount.setText(String.format(getString(R.string.number_of_group_member), group.getMemberCount()));
//			}
//		});
//	}
//
...
//		startActivityForResult(new Intent(this, ExitGroupDialog.class).putExtra("deleteToast", getString(com.tg.tgt.R.string.dissolution_group_hint)),
...
//		}
//		Toast.makeText(this, com.tg.tgt.R.string.messages_are_empty, Toast.LENGTH_SHORT).show();
//	}
//
//	/**
//	 * 退出群组
...
//		String st1 = getResources().getString(com.tg.tgt.R.string.Exit_the_group_chat_failure);
//		new Thread(new Runnable() {
//			public void run() {
//				try {
...
//						public void run() {
//							progressDialog.dismiss();
//							Toast.makeText(getApplicationContext(), getResources().getString(com.tg.tgt.R.string.Exit_the_group_chat_failure) + " " + e.getMessage(), Toast.LENGTH_LONG).show();
//						}
//					});
//				}
//			}
...
//		final String st5 = getResources().getString(com.tg.tgt.R.string.Dissolve_group_chat_tofail);
//		new Thread(new Runnable() {
//			public void run() {
//				try {
...
//		final String st6 = getResources().getString(com.tg.tgt.R.string.Add_group_members_fail);
//		new Thread(new Runnable() {
//
//			public void run() {
//				try {
...
//		switch (v.getId()) {
//			case com.tg.tgt.R.id.rl_switch_block_groupmsg: // 屏蔽或取消屏蔽群组
//				toggleBlockGroup();
//				break;
//
//			case com.tg.tgt.R.id.clear_all_history: // 清空聊天记录
//				String st9 = getResources().getString(com.tg.tgt.R.string.sure_to_empty_this);
...
//		        progressDialog.setCanceledOnTouchOutside(false);
//		    }
//			progressDialog.setMessage(getString(com.tg.tgt.R.string.Is_unblock));
//			progressDialog.show();
//			new Thread(new Runnable() {
//		        public void run() {
//		            try {
...
//		                    public void run() {
//		                        progressDialog.dismiss();
//		                        Toast.makeText(getApplicationContext(), com.tg.tgt.R.string.remove_group_of, Toast.LENGTH_LONG).show();
//		                    }
//		                });
//
//		            }
...
//
//		} else {
//			String st8 = getResources().getString(com.tg.tgt.R.string.group_is_blocked);
//			final String st9 = getResources().getString(com.tg.tgt.R.string.group_of_shielding);
...
//		dialog.setContentView(com.tg.tgt.R.layout.em_chatroom_member_menu);
//
//		int ids[] = { com.tg.tgt.R.id.menu_item_add_admin,
//				com.tg.tgt.R.id.menu_item_rm_admin,
//				com.tg.tgt.R.id.menu_item_remove_member,
//				com.tg.tgt.R.id.menu_item_add_to_blacklist,
//				com.tg.tgt.R.id.menu_item_remove_from_blacklist,
//				com.tg.tgt.R.id.menu_item_transfer_owner,
//				com.tg.tgt.R.id.menu_item_mute,
//				com.tg.tgt.R.id.menu_item_unmute};
//
//		for (int id : ids) {
...
//	int[] ids = {
//			com.tg.tgt.R.id.menu_item_transfer_owner,
//			com.tg.tgt.R.id.menu_item_add_admin,
//			com.tg.tgt.R.id.menu_item_rm_admin,
//			com.tg.tgt.R.id.menu_item_remove_member,
//			com.tg.tgt.R.id.menu_item_add_to_blacklist,
//			com.tg.tgt.R.id.menu_item_remove_from_blacklist,
...
//				holder.imageView = (ImageView) convertView.findViewById(com.tg.tgt.R.id.iv_avatar);
//				holder.textView = (TextView) convertView.findViewById(com.tg.tgt.R.id.tv_name);
//				holder.badgeDeleteView = (ImageView) convertView.findViewById(com.tg.tgt.R.id.badge_delete);
//				convertView.setTag(holder);
//			}else{
//				holder = (ViewHolder) convertView.getTag();
//			}
//
//			final LinearLayout button = (LinearLayout) convertView.findViewById(com.tg.tgt.R.id.button_avatar);
//
...
//
//			LinearLayout id_background = (LinearLayout) convertView.findViewById(com.tg.tgt.R.id.l_bg_id);
//			id_background.setBackgroundColor(convertView.getResources().getColor(
//					position == 0 ? com.tg.tgt.R.color.holo_red_light: com.tg.tgt.R.color.holo_orange_light));
...
//				holder.imageView.setImageResource(com.tg.tgt.R.drawable.em_smiley_add_btn);
//				if (isCanAddMember(group)) {
//					convertView.setVisibility(View.VISIBLE);
//					button.setOnClickListener(new OnClickListener() {
//						@Override
//						public void onClick(View v) {
//							final String st11 = getResources().getString(com.tg.tgt.R.string.Add_a_button_was_clicked);
//							EMLog.d(TAG, st11);
//							// 进入选人页面
...
//					id_background.setBackgroundColor(convertView.getResources().getColor(com.tg.tgt.R.color.gray_normal));
//				} else if (isInBlackList(username)) {
//					id_background.setBackgroundColor(convertView.getResources().getColor(com.tg.tgt.R.color.holo_black));
//				} else {
//					id_background.setBackgroundColor(convertView.getResources().getColor(com.tg.tgt.R.color.holo_blue_bright));
//				}
//
//				button.setOnClickListener(new OnClickListener() {
//					@Override
...
//							return;
//							//不是群主点击管理员无效
//						}else if(isInAdminist(username) && !isCurrentOwner(group)){
//							return;
//						}
//
//						operationUserId = username;
...
//		if(System.currentTimeMillis()-lastQueryTime<50){
//			return;
//		}
...
//				do {
////						if(result!=null && TextUtils.isEmpty(result.getCursor()))
////							break;
//					result = EMClient.getInstance().groupManager().fetchGroupMembers(groupId,
//							result != null ? result.getCursor() : "",
//							pageSize);
//					try {
//						//这里用一个值lastMember来控制，避免多次拉取的结果是一样的
//						if(lastMember!=null && lastMember.equals(result.getData().get(0))){
//                            continue;
//                        }
//						lastMember = result.getData().get(0);
//					} catch (Exception e) {
//						e.printStackTrace();
//					}
////						EMLog.d(TAG, "fetchGroupMembers result.size:" + result.getData().size());
//					EMLog.d(TAG, "fetchGroupMembers cursor:"+result.getCursor()+"\nfetchGroupMembers result:" + result.getData().toString());
