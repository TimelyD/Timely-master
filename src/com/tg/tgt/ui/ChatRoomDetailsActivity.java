...
public class ChatRoomDetailsActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.tg.tgt.R.layout.em_activity_chatroom_details);
		instance = this;
		st = getResources().getString(com.tg.tgt.R.string.people);
		loadingPB = (ProgressBar) findViewById(com.tg.tgt.R.id.progressBar);

		TextView chatRoomIdTextView = (TextView) findViewById(com.tg.tgt.R.id.tv_chat_room_id_value);
		TextView chatRoomNickTextView = (TextView) findViewById(com.tg.tgt.R.id.tv_chat_room_nick_value);
        ...
        RelativeLayout changeChatRoomNameLayout = (RelativeLayout) findViewById(com.tg.tgt.R.id.rl_change_chatroom_name);
        RelativeLayout changeChatRoomDescriptionLayout = (RelativeLayout) findViewById(com.tg.tgt.R.id.rl_change_chatroom_detail);
		...
		ownerAdminAdapter = new OwnerAdminAdapter(this, com.tg.tgt.R.layout.em_grid_owner, ownerAdminList);
		EaseExpandGridView ownerAdminGridView = (EaseExpandGridView) findViewById(com.tg.tgt.R.id.owner_and_administrators);
		...
		membersAdapter = new MemberAdapter(this, com.tg.tgt.R.layout.em_grid_owner, memberMuteBlockList);
	...
	protected void onActivityResult(int requestCode, int resultCode, final Intent data) {
		...
		String st2 = getResources().getString(com.tg.tgt.R.string.is_quit_the_chat_room);
		...
		String st5 = getResources().getString(com.tg.tgt.R.string.is_modify_the_group_name);
		...
		String st8 = getResources().getString(com.tg.tgt.R.string.Are_moving_to_blacklist);
		final String st9 = getResources().getString(com.tg.tgt.R.string.failed_to_move_into);

		final String stsuccess = getResources().getString(com.tg.tgt.R.string.Move_into_blacklist_success);
					...
					new Thread(new Runnable() {
						...
						public void run() {
							...
							runOnUiThread(new Runnable() {
								@Override
								public void run() {
									TextView tv = (TextView) findViewById(com.tg.tgt.R.id.tv_chat_room_nick_value);
				...
				try {
					...
					runOnUiThread(new Runnable() {
						public void run() {
                            ...
                            TextView chatRoomTitle = (TextView) findViewById(com.tg.tgt.R.id.tv_chatroom_name);
							...
							Button destroyButton = (Button)ChatRoomDetailsActivity.this.findViewById(com.tg.tgt.R.id.btn_destroy_chatroom);
	...
	public void onClick(View v) {
		switch (v.getId()) {
			case com.tg.tgt.R.id.clear_all_history: // clear conversation history
				...
				break;
			case com.tg.tgt.R.id.rl_change_chatroom_name:
				...
				break;
			case com.tg.tgt.R.id.rl_change_chatroom_detail:
