...
public class OfflinePushSettingsActivity extends BaseActivity implements CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle arg0) {
        super.onCreate(arg0);
        setContentView(com.tg.tgt.R.layout.activity_offline_push_settings);

        EaseTitleBar titleBar = (EaseTitleBar) findViewById(com.tg.tgt.R.id.title_bar);
        noDisturbOn = (CheckBox) findViewById(com.tg.tgt.R.id.cb_no_disturb_on);
        noDisturbOff = (CheckBox) findViewById(com.tg.tgt.R.id.cb_no_disturb_off);
        noDisturbInNight = (CheckBox) findViewById(com.tg.tgt.R.id.cb_no_disturb_only_night);
        Button saveButton = (Button) findViewById(com.tg.tgt.R.id.btn_save);
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                savingPd.setMessage(getString(com.tg.tgt.R.string.push_saving_settings));
                    ...
                    public void run() {
                        try {
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    savingPd.dismiss();
                                    Toast.makeText(OfflinePushSettingsActivity.this, com.tg.tgt.R.string.push_save_failed, Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                    }
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        switch (buttonView.getId()) {
            case com.tg.tgt.R.id.cb_no_disturb_on:
                if(isChecked){
                ...
                break;
            case com.tg.tgt.R.id.cb_no_disturb_off:
                if(isChecked){
                ...
                break;
            case com.tg.tgt.R.id.cb_no_disturb_only_night:
                if(isChecked){
                    noDisturbOn.setChecked(false);
                    noDisturbOff.setChecked(false);
