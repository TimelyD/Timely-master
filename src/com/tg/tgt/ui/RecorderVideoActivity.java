...
//				WindowManager.LayoutParams.FLAG_FULLSCREEN);// full screen
		...
		setContentView(com.tg.tgt.R.layout.em_recorder_activity);
	...
	private void initViews() {
		btn_switch = (ImageView) findViewById(com.tg.tgt.R.id.switch_btn);
		btn_switch.setOnClickListener(this);
		btn_switch.setVisibility(View.VISIBLE);
		mVideoView = (VideoView) findViewById(com.tg.tgt.R.id.mVideoView);
		btnStart = (ImageView) findViewById(com.tg.tgt.R.id.recorder_start);
		btnStop = (ImageView) findViewById(com.tg.tgt.R.id.recorder_stop);
		btnStart.setOnClickListener(this);
		btnStop.setOnClickListener(this);
		mSurfaceHolder = mVideoView.getHolder();
		mSurfaceHolder.addCallback(this);
		mSurfaceHolder.setType(SurfaceHolder.SURFACE_TYPE_PUSH_BUFFERS);
		chronometer = (Chronometer) findViewById(com.tg.tgt.R.id.chronometer);
	...
	public void onClick(View view) {
		switch (view.getId()) {
		case com.tg.tgt.R.id.switch_btn:
			switchCamera();
			break;
		case com.tg.tgt.R.id.recorder_start:
			// start recording
		    if(!startRecording())
		        return;
			Toast.makeText(this, com.tg.tgt.R.string.The_video_to_start, Toast.LENGTH_SHORT).show();
			...
			chronometer.start();
			break;
		case com.tg.tgt.R.id.recorder_stop:
			...
			new AlertDialog.Builder(this)
					.setMessage(com.tg.tgt.R.string.Whether_to_send)
					.setPositiveButton(com.tg.tgt.R.string.ok,
					...
					.setNegativeButton(com.tg.tgt.R.string.cancel,
							new DialogInterface.OnClickListener() {
	...
	public void onInfo(MediaRecorder mr, int what, int extra) {
		...
		if (what == MediaRecorder.MEDIA_RECORDER_INFO_MAX_DURATION_REACHED) {
			...
			String st3 = getResources().getString(com.tg.tgt.R.string.Whether_to_send);
			new AlertDialog.Builder(this)
					.setMessage(st3)
					.setPositiveButton(com.tg.tgt.R.string.ok,
							new DialogInterface.OnClickListener() {
							...
							}).setNegativeButton(com.tg.tgt.R.string.cancel, null)
					.setCancelable(false).show();
		}
	...
	private void showFailDialog() {
		new AlertDialog.Builder(this)
				.setTitle(com.tg.tgt.R.string.prompt)
				.setMessage(com.tg.tgt.R.string.Open_the_equipment_failure)
				.setPositiveButton(com.tg.tgt.R.string.ok,
						new DialogInterface.OnClickListener() {
