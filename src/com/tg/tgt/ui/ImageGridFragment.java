...
import com.tg.tgt.domain.VideoEntity;
import com.tg.tgt.video.util.ImageCache;
import com.tg.tgt.video.util.ImageResizer;
import com.tg.tgt.video.util.Utils;
import com.tg.tgt.widget.RecyclingImageView;
...
public class ImageGridFragment extends Fragment implements OnItemClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mImageThumbSize = getResources().getDimensionPixelSize(
				com.tg.tgt.R.dimen.image_thumbnail_size);
		mImageThumbSpacing = getResources().getDimensionPixelSize(
				com.tg.tgt.R.dimen.image_thumbnail_spacing);
		...
		mImageResizer.setLoadingImage(com.tg.tgt.R.drawable.em_empty_photo);
	...
	public View onCreateView(LayoutInflater inflater,
		...
		final View v = inflater.inflate(com.tg.tgt.R.layout.em_image_grid_fragment,
				container, false);
		final GridView mGridView = (GridView) v.findViewById(com.tg.tgt.R.id.gridView);
...
//				String st = getResources().getString(com.tg.tgt.R.string.temporary_does_not);
	...
	private class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup container) {
			 ...
			 if(convertView==null)
			 {
				 ...
				 convertView=LayoutInflater.from(mContext).inflate(com.tg.tgt.R.layout.em_choose_griditem, container,false);
				 holder.imageView=(RecyclingImageView) convertView.findViewById(com.tg.tgt.R.id.imageView);
				 holder.icon=(ImageView) convertView.findViewById(com.tg.tgt.R.id.video_icon);
				 holder.tvDur=(TextView)convertView.findViewById(com.tg.tgt.R.id.chatting_length_iv);
				 holder.tvSize=(TextView)convertView.findViewById(com.tg.tgt.R.id.chatting_size_iv);
			...
			String st1 = getResources().getString(com.tg.tgt.R.string.Video_footage);
			if(position==0)
			{
				holder.icon.setVisibility(View.GONE);
				holder.tvDur.setVisibility(View.GONE);
				holder.tvSize.setText(st1);
				holder.imageView.setImageResource(com.tg.tgt.R.drawable.em_actionbar_camera_icon);
			}else{
				...
				holder.imageView.setImageResource(com.tg.tgt.R.drawable.em_empty_photo);
