...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    private final static int DEFAULT_CLICKABLEA_COLOR_ID = R.color.ccc;
    /**整个textView的背景色*/
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = App.applicationContext.getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = App.applicationContext.getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
