...
public class GroupAdapter extends ArrayAdapter<GroupModel> {
	...
	public GroupAdapter(Context context, int res, List<GroupModel> groups) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (getItemViewType(position) == 0) {
			...
			((TextView) convertView.findViewById(R.id.name)).setText(getItem(position - headCount).getGroupName());
