...
public class UserProfileManager {
	...
	public synchronized EaseUser getCurrentUserInfo() {
		if (currentUser == null) {
			...
			currentUser.setChatidstate(SpUtils.get(App.applicationContext, Constant.STATE, ""));
		}
		return currentUser;
	}

	public void updateCurrentUserAvatar(String uri){
		currentUser.setAvatar(uri);
	}
	...
	public void asyncGetCurrentUserInfo() {
		setCurrentUserNick(SharedPreStorageMgr.getIntance().getStringValue(App.applicationContext, Constant.NICKNAME));
        setCurrentUserAvatar(SharedPreStorageMgr.getIntance().getStringValue(App.applicationContext,
                Constant.HEADIMAGE));
...
//		PreferenceManager.getInstance().setCurrentUserNick(nickname);
		SpUtils.put(App.applicationContext, Constant.NICKNAME, nickname);
	}

	public void setCurrentUserAvatar(String avatar) {
		getCurrentUserInfo().setAvatar(avatar);
//		PreferenceManager.getInstance().setCurrentUserAvatar(avatar);
		SpUtils.put(App.applicationContext, Constant.HEADIMAGE, avatar);
	}

	public void setCurrentUserState(String avatar) {
		getCurrentUserInfo().setChatidstate(avatar);
//		PreferenceManager.getInstance().setCurrentUserAvatar(avatar);
		SpUtils.put(App.applicationContext, Constant.STATE, avatar);
	}

	private String getCurrentUserNick() {
		return SpUtils.get(App.applicationContext, Constant.NICKNAME, "");
	}

	private String getCurrentUserState() {
		return SpUtils.get(App.applicationContext, Constant.STATE, "");
	}

	private String getCurrentUserAvatar() {
//		return PreferenceManager.getInstance().getCurrentUserAvatar();
		return SharedPreStorageMgr.getIntance().getStringValue(App.applicationContext, Constant.HEADIMAGE);
	}
