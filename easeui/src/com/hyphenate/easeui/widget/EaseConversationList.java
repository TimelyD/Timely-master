...
public class EaseConversationList extends ListView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        timeColor = ta.getColor(com.hyphenate.easeui.R.styleable.EaseConversationList_cvsListTimeTextColor, getResources().getColor(R.color.gray_normal));
    ...
    public interface EaseConversationListHelper{
         ...
         * @param name
         */
        void onSetIsMsgClock(String username, ImageView msgClock, ImageView avatar, TextView name);
