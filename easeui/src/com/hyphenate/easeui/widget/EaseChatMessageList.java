...
public class EaseChatMessageList extends RelativeLayout{
    ...
    public void init(String toChatUsername, int chatType, EaseCustomChatRowProvider customChatRowProvider) {
        ...
        messageAdapter.setInfoListener(listener);
    ...
    public void removeAllFireMsg(){
        messageAdapter.removeAllFireMsg();
    }
    
    protected void parseStyle(Context context, AttributeSet attrs) {
        TypedArray ta = context.obtainStyledAttributes(attrs, com.hyphenate.easeui.R.styleable.EaseChatMessageList);
        showAvatar = ta.getBoolean(com.hyphenate.easeui.R.styleable.EaseChatMessageList_msgListShowUserAvatar, true);
    ...
    private EaseChatRow.IInfoListener listener;
    public void setInfoListener(EaseChatRow.IInfoListener listener) {
