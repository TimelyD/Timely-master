...
public class CircleProgressView extends ProgressBar {
    ...
    private int mReachBarSize = PhoneUtil.dp2px(getContext(), 2); // 未完成进度条大小
    private int mNormalBarSize = PhoneUtil.dp2px(getContext(), 2); // 未完成进度条大小
    private int mReachBarColor = Color.parseColor("#108ee9"); // 已完成进度颜色
    private int mNormalBarColor = Color.parseColor("#FFD3D6DA"); // 未完成进度颜色
    private int mTextSize = PhoneUtil.sp2px(getContext(), 14); // 进度值字体大小
    ...
    private int mOuterSize = PhoneUtil.dp2px(getContext(), 1); // 外层圆环宽度
    ...
    public void setReachBarSize(int reachBarSize) {
        mReachBarSize = PhoneUtil.dp2px(getContext(), reachBarSize);
        invalidate();
    }
    ...
    public void setNormalBarSize(int normalBarSize) {
        mNormalBarSize = PhoneUtil.dp2px(getContext(), normalBarSize);
        invalidate();
    }
    ...
    public void setTextSize(int textSize) {
        mTextSize = PhoneUtil.sp2px(getContext(), textSize);
        invalidate();
    }
    ...
    public void setRadius(int radius) {
        mRadius = PhoneUtil.dp2px(getContext(), radius);
        invalidate();
    }
    ...
    public void setInnerPadding(int innerPadding) {
        mInnerPadding = PhoneUtil.dp2px(getContext(), innerPadding);
        int mInnerRadius = mRadius - mOuterSize / 2 - mInnerPadding;
        rectInner = new RectF(-mInnerRadius, -mInnerRadius, mInnerRadius, mInnerRadius);
        invalidate();
    }
    ...
    public void setOuterSize(int outerSize) {
        mOuterSize = PhoneUtil.dp2px(getContext(), outerSize);
        invalidate();
    }
