...
public interface IPhotoView {
    ...
    /**
     * Register a callback to be invoked when the MediaBean displayed by this view is long-pressed.
     *
     ...
     * View. An example would be the user panning or scaling the MediaBean.
     *
     * @param listener - Listener to be registered.
     */
    ...
    /**
     * Register a callback to be invoked when the MediaBean displayed by this View
