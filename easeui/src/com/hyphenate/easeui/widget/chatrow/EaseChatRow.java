...
//    protected boolean mIsFire;
    ...
    public EaseChatRow(Context context, EMMessage message, int position, BaseAdapter adapter) {
        ...
        //获取是否阅后即焚
//        mIsFire = message.getStringAttribute(EaseConstant.MESSAGE_ATTR_IS_FIRE, "0").equals("1");
//        Log.i("mIsFire", ""+mIsFire);
//        Log.i("MESSAGE_ATTR_IS_FIRE", message.getStringAttribute(EaseConstant.MESSAGE_ATTR_IS_FIRE, "0"));
        initView();
    }
    ...
    private void setUpBaseView() {
        ...
        if (timestamp != null) {
            if (position == 0) {
                Log.i("dcz_时间",timeUtil.getTimestampString(new Date(message.getMsgTime())));
        ...
        if (message.direct() == Direct.SEND) {
            ...
            if (mInfoListener != null && !message.getChatType().equals(EMMessage.ChatType.Chat)) {
                try {
                    isSetAvatar = mInfoListener.setInfo(message,userAvatarView, usernickView);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
        ...
        if (bubbleLayout != null) {
            ...
            bubbleLayout.setOnLongClickListener(new OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    Log.i("dcz","setOnLongClickListener");
                    if (itemClickListener != null) {
    ...
    protected IInfoListener mInfoListener;
    ...
    public interface IInfoListener {
        boolean setInfo(EMMessage message, ImageView avatar, TextView nick);
    }
        ...
        activity.runOnUiThread(new Runnable() {
            public void run() {
                if (errorCode == EMError.MESSAGE_INCLUDE_ILLEGAL_CONTENT) {
                    ToastUtils.makeText(activity.getApplicationContext(), activity.getString(R.string.send_fail) +
                ...
                } else if (desc != null && desc.contains("big")) {
                    ToastUtils.showToast(activity.getApplicationContext(), desc);
                } else {
                    ToastUtils.makeText(activity.getApplicationContext(), activity.getString(R.string.send_fail) +
