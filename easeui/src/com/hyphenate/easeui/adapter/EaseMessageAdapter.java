...
public class EaseMessageAdapter extends BaseAdapter {
    ...
    public void removeAllFireMsg() {
        if (messages != null && messages.length > 0) {
            for (EMMessage msg : messages) {
                if ("1".equals(msg.getStringAttribute(EaseConstant.MESSAGE_ATTR_IS_FIRE, "0"))) {
    ...
    protected EaseChatRow createChatRow(Context context, EMMessage message, int position) {
        ...
        chatRow.setInfoListener(mInfoListener);
        return chatRow;
    }
    protected EaseChatRow.IInfoListener mInfoListener;
